...
const getRnaSeqProps = (state, ownProps) => ({
  tpmGenes: getFamiliesByGuid(state)[ownProps.variant.familyGuids?.at(0)]?.tpmGenes,
  individualGeneData: getIndividualGeneDataByFamilyGene(state)[ownProps.variant.familyGuids?.at(0)],
})
