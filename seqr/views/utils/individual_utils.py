...
def add_or_update_individuals_and_families(project, individual_records, user, get_update_json=True, get_updated_individual_db_ids=False, get_created_counts=False, allow_features_update=False, allow_search_field_update=False):
    """
    ...
    for record in individual_records:
        created_individual = _update_from_record(
            record, user, families_by_id, individual_lookup, updated_family_ids, updated_individuals, parent_updates, updated_note_ids, allow_features_update, allow_search_field_update)
...
def _update_from_record(record, user, families_by_id, individual_lookup, updated_family_ids, updated_individuals, parent_updates, updated_note_ids, allow_features_update, allow_search_field_update):
    ...
    if allow_search_field_update and previous_id:
    ...
    is_updated = update_individual_from_json(individual, record, user=user, allow_unknown_keys=True, allow_features_update=allow_features_update, allow_search_field_update=allow_search_field_update)
    if is_updated:
        updated_individuals.add(individual)
